...
module PluginManager
  ...
  #-----------------------------------------------------------------------------
  def self.plugin_check_DBK(version = "1.1.7")
    if self.installed?("Deluxe Battle Kit", version, true)
      {"[DBK] Enhanced Battle UI"      => "2.0.2",
       "[DBK] SOS Battles"             => "1.0.6",
       "[DBK] Raid Battles"            => "1.0",
       "[DBK] Z-Power"                 => "1.0.6",
       "[DBK] Dynamax"                 => "1.0.7",
       "[DBK] Terastallization"        => "1.1.0",
       "[DBK] Improved Item AI"        => "1.0",
       "[DBK] Wonder Launcher"         => "1.0.2",
       "[DBK] Animated Pokémon System" => "1.0.4",
