module GameData
  class Species
    ...
    def self.editor_properties
      return [
        ["ID",                ReadOnlyProperty,                   _INTL("此宝可梦的ID。")],
        ["Name",              LimitStringProperty.new(Pokemon::MAX_NAME_SIZE), _INTL("此宝可梦的名称。")],
        ["FormName",          StringProperty,                     _INTL("此形态的名称。")],
        ["Types",             GameDataPoolProperty.new(:Type, false), _INTL("宝可梦的属性。")],
        ["BaseStats",         BaseStatsProperty,                  _INTL("宝可梦的种族值。")],
        ["GenderRatio",       GameDataProperty.new(:GenderRatio), _INTL("此物种雄性与雌性的 比例。")],
        ["GrowthRate",        GameDataProperty.new(:GrowthRate),  _INTL("宝可梦的成长速率。")],
        ["BaseExp",           LimitProperty.new(9999),            _INTL("战胜此物种时获得的 基础经验值。")],
        ["EVs",               EffortValuesProperty,               _INTL("战胜此物种时获得的 努力值。")],
        ["CatchRate",         LimitProperty.new(255),             _INTL("此物种的捕获率 （0-255）。")],
        ["Happiness",         LimitProperty.new(255),             _INTL("此物种的基础亲密度 （0-255）。")],
        ["Abilities",         AbilitiesProperty.new,              _INTL("宝可梦可能拥有的特 性（最多2个）。")],
        ["HiddenAbilities",   AbilitiesProperty.new,              _INTL("宝可梦可能具有的隐 藏特性。")],
        ["Moves",             LevelUpMovesProperty,               _INTL("宝可梦升级时会学到 的招式。")],
        ["TutorMoves",        EggMovesProperty.new,               _INTL("宝可梦通过TM/HM/ 招式教学者学会的招 式。")],
        ["EggMoves",          EggMovesProperty.new,               _INTL("宝可梦通过遗传学习 的招式。")],
        ["EggGroups",         EggGroupsProperty.new,              _INTL("此宝可梦的蛋组。")],
        ["HatchSteps",        LimitProperty.new(99_999),          _INTL("孵化此物种的蛋需要 的步数。")],
        ["Incense",           ItemProperty,                       _INTL("父母宝可梦产下此物 种的蛋需要携带的道 具。")],
        ["Offspring",         GameDataPoolProperty.new(:Species), _INTL("此物种的蛋可能孵化 出的所有物种（如果 为空，蛋只会孵出此 物种）。")],
        ["Height",            NonzeroLimitProperty.new(999),      _INTL("宝可梦的身高，单位 为0.1米。（例如： 42 = 4.2m）")],
        ["Weight",            NonzeroLimitProperty.new(9999),     _INTL("宝可梦的体重，单位 为0.1千克。（例如 ：42 = 4.2kg）")],
        ["Color",             GameDataProperty.new(:BodyColor),   _INTL("宝可梦的图鉴颜色。")],
        ["Shape",             GameDataProperty.new(:BodyShape),   _INTL("此物种的体形。")],
        ["Habitat",           GameDataProperty.new(:Habitat),     _INTL("此物种的栖息地。")],
        ["Category",          StringProperty,                     _INTL("此宝可梦的分类。")],
        ["Pokedex",           StringProperty,                     _INTL("此宝可梦在图鉴中的 描述。")],
        ["Generation",        LimitProperty.new(99_999),          _INTL("宝可梦首次登场的图 鉴编号。")],
        ["Flags",             StringListProperty,                 _INTL("区分此物种与其他物 种的英文单词/短语 。")],
        ["WildItemCommon",    GameDataPoolProperty.new(:Item),    _INTL("野生宝可梦经常携带 的道具。")],
        ["WildItemUncommon",  GameDataPoolProperty.new(:Item),    _INTL("野生宝可梦不常携带 的道具。")],
        ["WildItemRare",      GameDataPoolProperty.new(:Item),    _INTL("野生宝可梦很少携带 的道具。")],
