module GameData
  class TrainerType
    ...
    def self.editor_properties
      ...
      return [
        ["ID",         ReadOnlyProperty,               _INTL("训练家类型的ID （如：XXX）。")],
        ["Name",       StringProperty,                 _INTL("此训练家类型的名称 。")],
        ["Gender",     EnumProperty.new(gender_array), _INTL("训练家类型的性别。")],
        ["BaseMoney",  LimitProperty.new(9999),        _INTL("玩家赢取的钱为此数 乘于训练家所有宝可 梦中等级最高的那只 的等级。")],
        ["SkillLevel", LimitProperty2.new(9999),       _INTL("此训练家类型的招式 水平。")],
        ["Flags",      StringListProperty,             _INTL("用于让此训练家类型 的行为与其他类型不 同的英文单词/短语 。")],
        ["IntroBGM",   BGMProperty,                    _INTL("与此训练家类型对战 前播放的BGM。")],
        ["BattleBGM",  BGMProperty,                    _INTL("与此训练家类型对战 时播放的BGM。")],
        ["VictoryBGM", BGMProperty,                    _INTL("战胜此训练家类型后 播放的BGM。")]
      ]
    end
