...
MenuHandlers.add(:options_menu, :text_speed, {
  ...
  "order"       => 30,
  "type"        => EnumOption,
  "parameters"  => [_INTL("慢"), _INTL("中"), _INTL("快"), _INTL("即刻")],
...
MenuHandlers.add(:options_menu, :send_to_boxes, {
  ...
  "description" => _INTL("当队伍已满时是否自动发送宝可梦到盒子。"),
