...
class PokemonDuel
  ...
  def pbDuel(opponent, event, speeches)
    ...
    loop do
      ...
      list.push(_INTL("特别攻击")) if !@special[0]
      command = pbMessage(_INTL("选择命令。"), list, 0)
